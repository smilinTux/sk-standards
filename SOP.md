...
`sk-standards` is the canonical home of the SKWorld engineering standards: 26 standards
...
|---|---|---|
| The standards | `standards/*.md` | 26 canonical documents. Every `sk*` repo conforms to these. Indexed from `README.md`. |
...
flowchart TD
    subgraph skstd["sk-standards (this repo, no runtime)"]
      README["README.md<br/>the hub: indexes all 26 standards"]:::doc
      STD["standards/*.md<br/>26 canonical standards"]:::doc
...
1. **`README.md`** - the hub. A one-line "what it governs" for each of the 26 standards,
...
checks:
  ...
  - name: the standards count claimed throughout this SOP still matches the tree
    run: test "$(ls standards/*.md | wc -l)" = 26
